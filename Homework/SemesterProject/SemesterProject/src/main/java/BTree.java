...
public class BTree<Key extends Comparable<Key>, Value> implements java.io.Serializable
{
	...
	protected Entry(@SuppressWarnings("rawtypes") Comparable key, Object val, Node child)
	{
	    this.key = key;
	    this.val = val;
	    this.child = child;
    ...
    @SuppressWarnings("unchecked")
	private static boolean less(@SuppressWarnings("rawtypes") Comparable k1, @SuppressWarnings("rawtypes") Comparable k2)
    {
	return k1.compareTo(k2) < 0;
    }

    @SuppressWarnings("unchecked")
	private static boolean isEqual(@SuppressWarnings("rawtypes") Comparable k1, @SuppressWarnings("rawtypes") Comparable k2)
    {
	return k1.compareTo(k2) == 0;
    }
}